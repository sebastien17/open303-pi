...
namespace rosic
{
  ...
  */
  ...
  INLINE double Open303::getSample()
  {
    ...
    // (sequencer non utilise avec un sequenceur MIDI externe : condition
    // "sequencer OFF" de la version originale retiree, toujours vraie ici)
    idle = ampEnv.endIsReached() && fabs(tmp) < 0.000001; // ampEnvOut < 0.000001;
